...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      backup_clientes_20260903: {
        Row: {
          activity: string | null
          admin_comments: string | null
          admin_rev: number | null
          billing_same_as_contact: boolean | null
          can_confirm_order: boolean | null
      ...
      backup_configuracoes_20260903: {
        Row: {
          ...
          email_logo_position: string | null
          ...
          permite_cadastro_aberto: boolean | null
      ...
      backup_producao_pedidos_20260903: {
        Row: {
          created_at: string | null
      ...
      backup_produto_variantes_20260903: {
        Row: {
          ativo: boolean | null
          codigo: string | null
          created_at: string | null
