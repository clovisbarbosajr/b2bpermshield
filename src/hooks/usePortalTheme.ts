 ...
 * `public/portal-tema/styles.css` tem seletores GLOBAIS — `:root` com as variaveis,
 ...
 *
 * POR QUE `/portal-tema/...`, e nao `src/assets`:
 * o proprio CSS referencia `url("assets/flooring-hero.jpg")` por caminho
 * RELATIVO. Servido de `/portal-tema/styles.css`, isso resolve para
 * `/portal-tema/assets/flooring-hero.jpg` — certo, sem reescrita de bundler e sem
 * duplicar a imagem de 1,1 MB.
 *
 * A pasta se chama `portal-tema` e NAO `paginas` de proposito: as quatro
 * paginas HTML soltas foram APAGADAS em 26/ago. Elas respondiam em
 * `/paginas/index.html` e companhia, coexistindo com as telas de verdade — duas
 * versoes da mesma tela no ar, e a estatica nao autenticava ninguem. O que
 * sobrou aqui e so o tema: folha de estilo e imagens.
 */

const CSS_TEMA = "/portal-tema/styles.css";
const CSS_FONTES =
 ...
 * animacoes de `public/portal-tema/app.js`, portadas.
 *
