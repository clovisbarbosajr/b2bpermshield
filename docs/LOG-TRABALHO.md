...
- 2026-09-16 T25 INICIADO: reCAPTCHA v2 checkbox no cadastro. Site key recebida (publica). Secret salvo pelo dono no Lovable como `registercustomer`. Plano: widget explicito na tela, token no body do register-customer, siteverify na edge antes de qualquer consulta, CSP da Vercel libera google.com/gstatic.com.
- 2026-09-16 T25 EDITADO: commit reCAPTCHA (captcha.ts, edge, tela, CSP). 33 focados, tsc 0, check-edge OK, 7 mutantes pegos. Caçador iniciado.
- 2026-09-16 T25 CORRIGIDO: Caçador achou 3 (recusa pos-signUp deixava login sem ficha; script bloqueado sem aviso; widget 304px apos girar tela). Captcha agora tranca so os avisos; ficha sempre criada; resposta 400/503 so pelo captcha. 5 mutantes pegos. Caçador r2.
- 2026-09-16 T25 CORRIGIDO r2: 3 mutantes sobreviventes (religar aviso, return cedo, oraculo) agora morrem; aviso de widget bloqueado usa setter da montagem atual. Caçador r3.
- 2026-09-16 T25 r3 NAO CONVERGIA (guardas de texto sempre furadas): mudei a abordagem. Os 3 avisos foram para _shared/avisosCadastro.ts (fetch injetado, testado com fetch falso: permitido falso = 0 chamadas; corpos/headers identicos aos de antes). Edge sem fetch/throw proprios; 500 com mensagem fixa. 9 mutantes pegos. Caçador r4.
- 2026-09-16 T25 VALIDADO: Caçador r4 limpo; guarda da ligacao de env/janela do limite (mutante cronSecret pego). 942/942. Estresse concorrente NAO rodado (criaria logins reais e dispararia avisos). Push.
- 2026-09-16 T24/T25 FEITO: chave v2 checkbox (6LeJgr8t...) no ar; widget "Nao sou um robo" renderiza; edge redeployada pelo dono responde 400 "captcha failed" a token falso com e-mail inexistente (secret valido; nada criado/enviado). Chaves v3 antigas podem ser apagadas. Cadastro real ponta a ponta fica para o dono/Jessika (dispara e-mail/SMS).
- 2026-09-22 T26 INICIADO: painel ao vivo no /admin (vendas+pedidos, top produtos/clientes, estoque/cadastros), SO ADMIN, atualizacao automatica. Branch painel-admin-live; NAO publicar ate o dono liberar.
- 2026-09-22 T26 SPEC APROVADA: receita = pedidos.total (com imposto/frete), clique abre lista ja filtrada (mexe em Pedidos e Clientes), polling 60s pausado com aba oculta, admin-only na UI (RLS continua liberando staff - avisado ao dono).
- 2026-09-22 T26 CORRIGIDO r2: 7 achados confirmados pelo cetico. Feitos: faixa de ano em periodoAnterior, borda UTC do filtro de entrega (defeito antigo), espera de 400ms ao digitar data, periodo automatico acompanha a virada do dia, testes que pegam os 3 mutantes sobreviventes, rotulo card x lista. Fora: link ?customer= (virou T27) e casar card com lista por status (lista so filtra UM status). 1003/1003.
- 2026-09-22 T26 CORRIGIDO r3: geracao sobe antes da guarda (periodo invalido nao deixa leitura velha escrever), periodoUsavel barra ano digitado intermediario, data de ENTREGA passa a ser lida em UTC na lista admin, no portal (tela+CSV), no detalhe e no preview de e-mail. Testes de comportamento para o tick de 60s, virada do dia e periodo invalido; 4 mutantes novos pegos. 1005/1005.
- 2026-09-22 T26 r4: aviso visivel de periodo invalido (Refresh silencioso era o unico achado) + testes que prendem a classe "data de entrega em UTC" nas 4 telas e periodoUsavel. 5 mutantes pegos. 1015/1015.
- 2026-09-22 T26 PRONTO: aviso de periodo invalido so apos parar de digitar e com o motivo certo; 3 mutantes pegos; 1015/1015. AGUARDANDO o dono liberar publicacao (branch painel-admin-live, sem push).
- 2026-09-22 T26/T27 PUBLICADOS: painel ao vivo no ar; filtro por cliente com sub-logins, nome do cliente vindo da ficha e uuid insensivel a caixa (tambem no Create Order). 1025/1025.
- 2026-09-22 DOMINIO: b2b.permshield.com criado. Vercel: dominio adicionado ao projeto b2bpermshield. Cloudflare (conta Jess@zapsupplies.com): CNAME b2b -> c063d105e07b11c0.vercel-dns-017.com, DNS only. So ADICIONEI registro (22->23); nada editado/apagado. https://b2b.permshield.com responde 200 e permshield.com seguiu 200 o tempo todo. FALTA: PORTAL_URL e Site URL/redirects no Lovable.
- 2026-09-22 DOMINIO parte 2: no Lovable, adicionei https://b2b.permshield.com/** aos Redirect URLs (9->10, nada removido) e troquei o Site URL para https://b2b.permshield.com ("Auth config updated", confirmado apos recarregar). Cadastro abre no dominio novo com o reCAPTCHA renderizando. PORTAL_URL o dono ja tinha trocado.
